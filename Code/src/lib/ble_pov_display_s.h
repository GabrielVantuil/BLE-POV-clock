...
#define POV_DISPLAY_S_UUID_MODE_CHAR          		0x0001
#define POV_DISPLAY_S_UUID_GET_LED_AMOUNT_CHAR		0x0002
#define POV_DISPLAY_S_UUID_SET_TEXT_CHAR      		0x0003
#define POV_DISPLAY_S_UUID_SET_LEDS_CHAR      		0x0004
...
struct ble_pov_display_s_s{
    ...
    ble_gatts_char_handles_t    get_led_amount_handles;  
