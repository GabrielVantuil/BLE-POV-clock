...
#define DEVICE_NAME                     "GV POV display"                   		/**< Name of device. Will be included in the advertising data. */
...
#define MAX_CONN_INTERVAL               MSEC_TO_UNITS(20, UNIT_1_25_MS)  		/**< Maximum acceptable connection interval */
#define SLAVE_LATENCY                   0                                		/**< Slave latency. */
#define CONN_SUP_TIMEOUT                MSEC_TO_UNITS(200, UNIT_10_MS)  		/**< Connection supervisory time-out (recommended 4x MAX_CONN_INTERVAL). */	
